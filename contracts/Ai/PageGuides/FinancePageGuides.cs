...
public static class FinancePageGuides
{
    public static readonly IReadOnlyList<PageGuide> Guides = new PageGuide[]
    {
        new("/finance/allocation", "Cost allocation",
            ...
            + "order (a bill whose lines name two orders is proposed line by line; any line can be "
            + "split across the supplier's open orders on the card) — one Approve allocates, links "
