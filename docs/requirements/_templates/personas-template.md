...
- _the things they complain about today_

### Key journeys they participate in
- _link to journey files_

### Permissions needed
- _high-level — feeds the permission matrix_

### Devices & environment
- _desk-based / on-site / mobile, M365 access, Teams usage_
...
- Quote templates inconsistent across reps.
...
- Read all customers
- Draft quotes; cannot approve above threshold
